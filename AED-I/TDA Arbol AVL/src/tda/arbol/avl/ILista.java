...
public interface ILista<T> {
     ...
     * @param nodo - Nodo a agregar
     */
    public void insertarAlFinal(Nodo<T> nodo); 

    /**
     * Metodo encargado de agregar un nodo ordenado según su etiqueta en la lista.
     *
     * @param nodo - Nodo a agregar
     */   
    
    public boolean insertarOrdenadamente(Nodo<T> nodo);
    
    /**
     * Metodo encargado de a partir de una lista desordenada devolverla ordenada.
     *
     * @param nodo - Nodo a agregar
     */   
